...
INSERT INTO public.charity(
	...
	imageurl, 
	description)
	VALUES ('Novak Djokovic Foundation', null, 
		'https://novakdjokovicfoundation.org/', 'https://www.facebook.com/NovakDjokovicFoundation', null, 'https://twitter.com/NovakFoundation', null, 
		'https://novakdjokovic.com/wp-content/uploads/2013/03/fondacije_vest.jpg', 
		'The Novak Djokovic Foundation is a non-profit organization founded by the Serbian tennis player Novak Djokovic and his wife Jelena. Established in 2007, the Foundation''s mission is to improve the educational opportunities and outcomes for children, especially those from disadvantaged backgrounds. The Foundation operates in Serbia and supports a range of programs and initiatives aimed at improving access to quality education, supporting early childhood development, and fostering social inclusion. The Foundation''s work includes building and renovating schools and kindergartens, providing educational materials and training for teachers, and supporting innovative approaches to learning. Through its efforts, the Novak Djokovic Foundation aims to help children achieve their full potential and contribute to the development of their communities.'
		);
